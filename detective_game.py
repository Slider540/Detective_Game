...
back_main_screen = pygame.image.load('game_back.jpg').convert()
back = pygame.image.load('game_back_floor.jpg').convert()
...
text_surface = text_font.render('Detective Game', False, 'White')
